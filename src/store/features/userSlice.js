...
import OnlineService from '../../config/OnlineService';
...
export const fetchDoOnline= createAsyncThunk(
    'user/fetchDoOnline',
    async (token)=>{
        await axios.post(UserService.online,{
            token: token
        })
        .then((res)=>console.log('İşlem başarılı.....: ',res))
        .catch((err)=>console.log('Hata....: ', err));

    }
);
export const fetchGetQuestions= createAsyncThunk(
    'user/fetchGetQuestions',
    async ()=>{
       return await axios.get(UserService.getquestion,{
        })
        .then((res)=>res.data)
        .catch((err)=>console.log('Hata....: ', err));
...
export const fetchDoOffline= createAsyncThunk(
    'user/fetchDoOffline',
    async (token)=>{
        await axios.post(UserService.offline,{
            token: token
        })
        .then((res)=>console.log('İşlem başarılı.....: ',res))
        .catch((err)=>console.log('Hata....: ', err));
...
export const fetchOnlineList= createAsyncThunk(
    ...
    async ()=>{     
        const result = await axios.get(OnlineService.online)
        .then(res=>res.data)      
        .catch((err)=>console.log('Hata....: ', err));
        return result;
    }
